...
public class CompletedTourAdapter extends BaseAdapter {
    ...
    public CompletedTourAdapter(Context context,ArrayList<BookingData> data)
    {
...
//        }
        if(data.get(position).Status().equals("Dispatch"))
        {
            holder.ClinetName.setText(data.get(position).getClientName());
